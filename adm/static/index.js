$(() => {
  ...
  const fnShowLogin = () => {
    ...
    txt += '</div>';
    txt += '<div>';
    txt += '<button type="button" class="btn-login px-4 py-2 rounded-md bg-blue-600 hover:bg-blue-700 text-white transition-colors">로그인</button>';
    ...
    txt += '<button type="button" class="btn-rigister px-4 py-2 rounded-md bg-blue-600 hover:bg-blue-700 text-white transition-colors" style="display: none;">등록</button>';
    ...
    //* TEST
    $('#root form[name="loginForm"] #login_id').val('test@test.com');
    //*/
    const pwd_placeholder = '영문 숫자 특수기호 조합 8 ~ 20자리';
    ...
    $('#root form[name="loginForm"] button.btn-signup').on('click', function() {
      ...
      $('#root form[name="loginForm"] #login_pwd').attr('placeholder', pwd_placeholder).attr('autocomplete', 'new-password');
  ...
  const fnInitModal = () => {
    ...
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500 uppercase">user id</th>';
    txt += '<td class="px-6 py-4 font-mono font-bold text-blue-600"><span class="user_id"></span></td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">성별</th>';
    txt += '<td class="px-6 py-4 text-gray-600"><span class="gender"></span></td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">나이</th>';
    txt += '<td class="px-6 py-4 text-gray-600"><span class="age"></span></td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">페르소나</th>';
    txt += '<td class="px-6 py-4 text-gray-600"><span class="persona_name"></span></td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">투자 성향</th>';
    ...
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">risk_tolerance</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    txt += '<input name="risk_tolerance" class="w-full px-3 py-2 text-gray-600 border border-dark rounded-sm" value="">';
    txt += '</td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">investment_style</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    txt += '<input name="investment_style" class="w-full px-3 py-2 text-gray-600 border border-dark rounded-sm" value="">';
    txt += '</td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">preferred_sectors</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    ...
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">holding_period</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    txt += '<input name="holding_period" class="w-full px-3 py-2 text-gray-600 border border-dark rounded-sm" value="">';
    txt += '</td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">typical_behavior</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    txt += '<input name="typical_behavior" class="w-full px-3 py-2 text-gray-600 border border-dark rounded-sm" value="">';
    txt += '</td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">favorite_patterns</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    ...
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">specific_stocks</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    ...
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">analysis_tendency</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    txt += '<input name="analysis_tendency" class="w-full px-3 py-2 text-gray-600 border border-dark rounded-sm" value="">';
    txt += '</td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">special_note</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
    txt += '<input name="special_note" class="w-full px-3 py-2 text-gray-600 border border-dark rounded-sm" value="">';
    txt += '</td>';
    txt += '</tr>';
    txt += '<tr>';
    txt += '<th scope="row" class="px-6 py-3 font-semibold text-gray-500">lua_branch</th>';
    txt += '<td class="px-6 py-4 text-gray-600">';
  ...
  const fnGeneratePersonaList = () => {
    ...
    if (personaList && personaList.length) {
      for (const item of personaList) {
        ...
        txt += `<td class="px-6 py-4 text-center text-gray-600"><button type="button" class="btn-train px-4 py-2 text-white bg-pink-500 rounded-md" data-id="${item['user_id']}">봇 학습</button></td>`;
        txt += '</tr>';
      }
    } else {
      txt += '<tr>';
