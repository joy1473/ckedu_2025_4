document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMessage(text, sender) {
        ...
        // LUA (assistant) icon removed as requested
        const assistantIcon = '';

        const avatarIcon = sender === 'user' ? userIcon : assistantIcon;

        // Condition to hide avatar container for assistant if empty
        const avatarHtml = sender === 'user' ? `<div class="avatar">${avatarIcon}</div>` : '';
